...
angular.module('estudiantes').controller('EstudiantesController', ['$scope', '$stateParams', '$location', '$filter', '$http', 'Authentication', 'Estudiantes', '$upload', 'Notas', 'GetNotas', 'GetAdmitidos', 'Decimo', 'Undecimo', 'Nacionalidad',
	function($scope, $stateParams, $location, $filter, $http, Authentication, Estudiantes, $upload, Notas, GetNotas, GetAdmitidos, Decimo, Undecimo, Nacionalidad) {
        ...
        $scope.generar_reporte = function(){
            ...
            if(reporte.val === 1){
                ...
                estudiantes_undecimo.$promise.then(function(estudiantes){
                    ...
                    titulo += '\nProfesores:\nAsignaturas:';
                    if(data.length > 0) {
                        $scope.generatePDF('Escogencia de ciencia bachierato', encabezado, titulo, columns, data, 165);
                    }
                    else{
                        alert('No existen suficientes estudiantes para generar el reporte');
                    }
                ...
                estudiantes_decimo.$promise.then(function(estudiantes) {
                    ...
                    if(data.length > 0) {
                        $scope.generatePDF('Lista para la biblioteca décimo', encabezado, titulo, columns, data, 95);
                    }
                    else{
                        alert('No existen suficientes estudiantes para generar el reporte');
                    }
                ...
                estudiantes_undecimo.$promise.then(function(estudiantes){
                    ...
                    if(data.length > 0) {
                        $scope.generatePDF('Lista para la biblioteca undécimo', encabezado, titulo, columns, data, 95);
                    }
                    else{
                        alert('No existen suficientes estudiantes para generar el reporte');
                    }
                ...
                estudiantes_decimo.$promise.then(function(estudiantes) {
                    ...
                    titulo += '\nProfesores:\nAsignaturas:';
                    if(data.length > 0) {
                        $scope.generatePDF('Lista participación olimpiadas décimo', encabezado, titulo, columns, data, 165);
                    }
                    else{
                        alert('No existen suficientes estudiantes para generar el reporte');
                    }
                ...
                estudiantes_undecimo.$promise.then(function(estudiantes){
                    ...
                    titulo += '\nProfesores:\nAsignaturas:';
                    if(data.length > 0) {
                        $scope.generatePDF('Lista participación olimpiadas undécimo', encabezado, titulo, columns, data, 165);
                    }
                    else{
                        alert('No existen suficientes estudiantes para generar el reporte');
                    }
        ...
        $scope.generatePDF = function(filename, encabezado, titulo, columns, data, starty){
