...
angular.module('estudiantes').controller('EstudiantesController', ['$scope', '$stateParams', '$location', '$filter', '$http', 'Authentication', 'Estudiantes', '$upload', 'Notas', 'GetNotas', 'GetAdmitidos', 'Decimo', 'Undecimo', 'Nacionalidad',
	function($scope, $stateParams, $location, $filter, $http, Authentication, Estudiantes, $upload, Notas, GetNotas, GetAdmitidos, Decimo, Undecimo, Nacionalidad) {
		...
		$scope.create = function() {
            ...
            function insertarEstudiante(){
                ...
                var estudiante = new Estudiantes ({
                    ...
                    foto: $scope.foto,
                    anno_ingreso: $scope.generacion,//new Date().getFullYear(),
        ...
        $scope.generar_reporte = function(){
            ...
            if(reporte.val === 1){
                ...
                estudiantes_decimo.$promise.then(function(estudiantes) {
                    ...
                    angular.forEach(estudiantes, function (estudiante_decimo) {
                        ...
                        if ((estudiante_decimo.admitido) && (!estudiante_decimo.traladado)) {
                            htmlbody += '<tr>\n';
                            htmlbody += '<td>' + estudiante_decimo.nacionalidad + '</td>\n' +
                    ...
                    $scope.generatePDF('Lista de ausencias décimo', encabezado,titulo,htmlheader + htmlbody + htmlfooter, 60);
                    htmlbody = '';
                    h, t, m = 0;
                });
                ...
                estudiantes_undecimo.$promise.then(function(estudiantes){
                    ...
                    angular.forEach(estudiantes, function(estudiante_undecimo){
                        ...
                        if((estudiante_undecimo.admitido) && (!estudiante_undecimo.traladado)) {
                            htmlbody += '<tr>\n';
                            htmlbody += '<td>' + estudiante_undecimo.nacionalidad + '</td>\n' +
                    ...
                    var titulo = '                   CONTROL DE AUSENCIAS UNDÉCIMO AÑO ' + new Date().getFullYear() +'\n' +
                        'Profesor: __________________                         Mes:________________ \n' +
                        'Asignatura: ________________                         A = Ausencia, T = Tardía';
                    $scope.generatePDF('Lista de ausencias undécimo', encabezado,titulo,htmlheader + htmlbody + htmlfooter, 60);
                });
            }
                ...
                estudiantes_decimo.$promise.then(function(estudiantes) {
                    ...
                    angular.forEach(estudiantes, function (estudiante_decimo) {
                        ...
                        if ((estudiante_decimo.admitido) && (!estudiante_decimo.traladado)) {
                            htmlbody += '<tr>\n';
                            htmlbody += '<td>' + estudiante_decimo.nacionalidad + '</td>\n' +
                                '<td>' + estudiante_decimo.segundo_apellido + '</td>\n<td>' + estudiante_decimo.primer_apellido + '</td>\n<td>' + estudiante_decimo.name +  '</td>\n' +
                                '<td>' + estudiante_decimo.celular + '</td>\n' + '<td>' + estudiante_decimo.correo + '</td>\n';
                            htmlbody += '</tr>\n';
                        }
                    })
                    var t = m + h;
                    ...
                    var titulo = '';
                    $scope.generatePDF('Lista cedula carne y apellidos undécimo', encabezado,titulo,htmlheader + htmlbody + htmlfooter, 47);
                    htmlbody = '';
                    h, t, m = 0;
                });
                var estudiantes_undecimo = Undecimo.query().$promise.then;
                estudiantes_undecimo.$promise.then(function(estudiantes){
                    ...
                    angular.forEach(estudiantes, function(estudiante_undecimo){
                        ...
                        if((estudiante_undecimo.admitido) && (!estudiante_undecimo.traladado)) {
                            htmlbody += '<tr>\n';
                            htmlbody += '<td>' + estudiante_undecimo.nacionalidad + '</td>\n' +
                                '<td>' + estudiante_undecimo.segundo_apellido + '</td>\n<td>' + estudiante_undecimo.primer_apellido + '</td>\n<td>' + estudiante_undecimo.name +  '</td>\n' +
                                '<td>' + estudiante_undecimo.celular + '</td>\n' + '<td>' + estudiante_undecimo.correo + '</td>\n';
                            htmlbody += '</tr>\n';
                        }
                    });
                    var t = m + h;
                ...
                estudiantes_decimo.$promise.then(function(estudiantes) {
                    ...
                    $scope.generatePDF('Lista ciencia para bachillerato décimo', encabezado,titulo,htmlheader + htmlbody + htmlfooter, 60);
                    htmlbody = '';
                    h, t, m = 0;
                });
                var estudiantes_undecimo = Undecimo.query().$promise.then;
                estudiantes_undecimo.$promise.then(function(estudiantes){
                    ...
                    $scope.generatePDF('Lista ciencia para bachillerato undécimo', encabezado,titulo,htmlheader + htmlbody + htmlfooter, 60);
                });
            }
                ...
                estudiantes_decimo.$promise.then(function(estudiantes) {
                    ...
                    var encabezado =
                        ...
                        'Telefax: 2475-7089,Tel: 2401-3122\n';
                    var titulo = '';
                    $scope.generatePDF('Lista correos décimo', encabezado,titulo,htmlheader + htmlbody + htmlfooter, 47);
                    htmlbody = '';
                    h, t, m = 0;
                });
                var estudiantes_undecimo = Undecimo.query().$promise.then;
                estudiantes_undecimo.$promise.then(function(estudiantes){
                    ...
                    var encabezado =
                        ...
                        'Telefax: 2475-7089,Tel: 2401-3122\n';
                    var titulo = '';
                    $scope.generatePDF('Lista correos undécimo', encabezado,titulo,htmlheader + htmlbody + htmlfooter, 47);
                });
            }
        ...
        $scope.generatePDF = function(filename, encabezado, titulo, html, y_table){
            var doc = jsPDF();
